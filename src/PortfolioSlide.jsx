...
function PortfolioSlide(props) {
  ...
  return (
    <div className={style.container}>
      ...
      <Button className={style.button} style={{ borderRadius: "100%",border:"2px solid",borderColor:"#f7f7f7",left:0.03125*window.innerWidth,top:0.821*window.innerHeight,position:"absolute"}}>
